...
def sequential(doc_matrix: csr_matrix, keys:list, threshold:float) -> Tuple[List[Tuple[tuple,float]],float]:
    ...
    to_return = [((index__doc_id_map[index1],index__doc_id_map[index2]),scores[index1,index2]) for index1, index2 in unique_pairs]
...
if __name__ == '__main__':
    ...
    spark_(doc_matrix.toarray(), keys, 0.3, 8, 1)
    """